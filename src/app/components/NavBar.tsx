export default function Header() {
  return (
    <div>
      <header className="flex border-b py-3 px-4 sm:px-10 bg-gradient-to-r from-blue-200 via-pink-200 to-sky-200 text-gray-800 font-[sans-serif] min-h-[65px] tracking-wide relative z-50 shadow-md">
        <div className="flex flex-wrap items-center gap-4 max-w-screen-xl mx-auto w-full">
          ...
          >
            <button
              id="toggleClose"
              className="lg:hidden fixed top-2 right-4 z-[100] rounded-full bg-white w-9 h-9 flex items-center justify-center border shadow-md"
            >
              <svg
            ...
            >
              <li className="max-lg:border-b max-lg:py-3 px-3">
                <a
                  ...
                  className="lg:hover:text-[#ff7f50] text-[#ff7f50] block text-[15px]"
                >
                  Home
                </a>
              </li>
              <li className="max-lg:border-b max-lg:py-3 px-3">
                <a
                  href="javascript:void(0)"
                  className="lg:hover:text-[#ff7f50] text-gray-600 block text-[15px]"
                >
                  About
                </a>
              </li>
